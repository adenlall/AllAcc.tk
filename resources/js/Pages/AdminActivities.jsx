...
export default function AdminActivities() {
    ...
    const { is_admin, usersF,usersL,mostV,lastU,oldestU, } = usePage().props;
    ...
    return (
        <>
            <div id='#head' className='w-[95%] sm:w-[72%] space-y-3 h-full pb-[1.3em] flex flex-col'>
                ...
                <h3 className='text-xl font-bold pt-3'>Oldest users</h3>
                        ...
                        <tbody>
                            {usersF.map(user => (
                                <tr>
                                    ...
                                    <th className="md:max-w-[4em] max-w-fit overflow-hidden text-ellipsis">{user.created_at}</th>
                ...
                <h3 className='text-xl font-bold pt-3'>Latest users</h3>
                <div class="overflow-x-auto">
                    <table class="table table-normal w-full">
                        <thead>
                            <tr>
                ...
                <h3 className='text-xl font-bold pt-3'>Younger users</h3>
