        ...
        <>
            <footer className="text-white bg-gradient-to-r bg-ago">
                <div className="max-w-screen-xl p-12 mx-auto sm:px-6 lg:px-8">
                    ...
                    <div className="pt-12 mt-8 border-t border-white/25 sm:items-center sm:justify-between sm:flex">
                        ...
                        <div className="flex justify-center mt-6 space-x-6 sm:justify-end sm:mt-0">
                            <a href="https://instagram.com/aden_lall" className="p-2 border rounded-full border-white/25 hover:opacity-75" target="_blank" rel="noreferrer">
                            ...
                            <a href="https://twitter.com/adenlall" className="p-2 border rounded-full border-white/25 hover:opacity-75" target="_blank" rel="noreferrer">
