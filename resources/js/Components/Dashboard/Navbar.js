            ...
            <div className="navbar bg-[#042b28]">
                <div className="navbar-start">
                    <div className="dropdown">
                        ...
                        <ul tabIndex="0" className="menu menu-compact space-y-2 dropdown-content mt-3 p-2 shadow bg-base-100 rounded-box w-52">
                            <li><Link className={pageName === 'Home' ? 'font-bold text-lg text-black bg-accent rounded-xl' : 'text-drk'} href="/" >Home</Link></li>
                            ...
                            {auth.user !== null
                                ...
                                <>
                                    ...
                                    <li><Link className={pageName === 'Setting' ? 'font-bold text-lg bg-accent rounded-xl text-black' : 'text-drk'} href="/setting" >Setting</Link></li>
