            ...
            <div>
                <div className="flex flex-col shadow-lg lg:flex-row items-center justify-between p-2 text-lg  rounded-lg font-bold bg-ago text-black w-full">
                    <div className="flex flex-col space-y-3 sm:space-y-0 sm:flex-row items-center justify-center lg:w-auto w-full">
                        <p className="bg-ap2 text-sm lg:text-lg flex rounded-lg mr-0 lg:mr-[-0.2em] p-2 lg:w-auto w-full "><span className="sm:block hidden">https://</span>allacc.herokuapp.com/{auth.user.username}</p>
                        <span className="p-2 pl-[0.1em] border-dashed border-[#042b28] border-[0.2em] sm:w-auto w-full bg-ap2 rounded-lg text-black font-bold md:text-lg lg:text-xl text-lg flex items-center" style={{ 'boxShadow': '-4px 5px 0px 0px black' }}>?from=<input type="text" name="place" id="place" className="input bg-white sm:h-fit lg:h-[3em] h-[3em] text-sm w-auto sm:w-[5em] lg:w-auto" /></span>
                    </div>
                    <div className="lg:pt-0 pt-3 flex items-center justify-start lg:w-auto w-full">
                                    ...
                                    <h4 className="text-sm italic text-[#3c3c3c]">Add your outside sources from the input above to see them here</h4>
                                        <article className="text-[#3c3c3c]">
                                            ...
                                            <p className="article text-lg space-y-2">
                                                ...
                                                <li>At the end, your public page URL will be like this <code className="text-black italic">https://allacc.herokuapp.com/{auth.user.username}/<span className="font-bold">?from=twitter</span></code></li>
