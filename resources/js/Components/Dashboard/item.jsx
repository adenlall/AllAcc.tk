            ...
            <form onSubmit={handleSubmit} className='flex flex-col space-y-0 pl-2'>
                ...
                <div className="form-control">
                    ...
                    <label className="input-group">
                        <span>@</span>
                        <input id="data" value={values.data} onChange={handleChange} type="text" placeholder="aden_lall_02" className="input input-accent w-[inherit] bg-white text-black input-bordered" />
                    </label>
                    {errors.data ?(
